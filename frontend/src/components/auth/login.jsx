...
export default function Login({next}) {
    ...
    function submitForm() {
        if(!form.password || !form.email) {
            setError("Assurez-vous d'avoir saisi à la fois l'e-mail et le mot de passe !")
            return;
        }
        ...
        <Background>
            <div className="w-[350px] h-[500px] bg-white border rounded-md shadow px-4 flex flex-col justify-between">
                ...
                <div className="w-full space-y-6">
                    ...
                    <div className="w-full space-y-[15px]">
                        ...
                        <div className="w-full border border-gray-300 rounded flex items-center space-x-2 group p-1.5 hover:border-gray-400">
                            ...
                            <input value={form.password} onChange={handleChange} name="password" type="password" className="w-full border-0 focus:outline-none text-gray-700" placeholder="Mot de passe"  />
                        </div>
                ...
                <div className="w-full flex items-center justify-center mb-6">
                    <p className="text-gray-500">Vous n'avez pas de compte? <a href="/signup" className="text-gradient">créer une</a></p>
                </div>
            </div>
        </Background>
    )
